...
- [ICBOMS](https://icboms.com/) - Semiconductor parametric search engine and BOM quotation tool with open [MCP / AI Agent API](https://icboms.com/llms.txt) for real-time inventory and spec lookups.
